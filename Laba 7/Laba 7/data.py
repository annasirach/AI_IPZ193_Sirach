# 1 task
Ukraine_map = ["Вінниця", "Дніпро", "Донецьк", "Житомир", "Запоріжжя", "Івано-Франківськ", "Київ", "Кропивницький", "Луганськ", "Луцьк", "Львів", "Миколаїв", "Одеса", "Полтава", "Рівне", "Сімферополь", "Суми", "Тернопіль", "Ужгород", "Харків", "Херсон", "Хмельницький", "Черкаси", "Чернівці", "Чернігів"]
Ukraine_dis = [
...
# 2 task
manager_map = ["Дзвінок клієнту", "Зідзвон", "Зум-міт", "Документація", "Тестування", "Здача проекту", "Звітність"]
manager_dis = [
    [0, 1, 2, 3, 4, 5, 6],
    [6, 0, 1, 2, 3, 4, 5],
    [5, 6, 0, 1, 2, 3, 4],
...
# 3 task
mom_map = ["Позамітати", "Вимити підлогу", "Провітрити", "Витерти пил", "Приготувати вечерю"]
mom_dis = [
    [0, 4, 1, 3, 9],
    [9, 0, 3, 1, 4],
    [1, 3, 0, 9, 5],
...
# 4 task
student_map = ["СШІ", "Лінукс", "Реакт", "Моделювання", "Хмарні", "Іноземна", "Політологія"]
student_dis = [
    [0, 5, 3, 16, 12, 8, 10],
    [10, 0, 5, 3, 16, 12, 8],
    [8, 10, 0, 5, 3, 16, 12],
