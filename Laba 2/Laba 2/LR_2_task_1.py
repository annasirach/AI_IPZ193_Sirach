...
for i, item in enumerate(input_data):
    if item.isdigit():
        ...
        count += 1
input_data_encoded = np.array(input_data_encoded).reshape(1, -1) #Функция reshape() изменяет форму массива без изменения его данных.
...
# Обчислення значення інших показників якості класифікації (акуратність, повнота, точність)
num_folds = 3
